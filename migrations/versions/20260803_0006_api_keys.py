...
NOTE: The FastAPI pilot has been removed. This migration is retained only
to preserve the Alembic chain for databases that already applied it.
The api_keys table is dropped by the follow-up migration (20260926_0007).
"""
